...
function SortableProjectRow({ project, categoryName, onDelete, onEdit }: { project: Project, categoryName: string, onDelete: (id: string) => void, onEdit: (id: string) => void }) {
  const {
    attributes,
    listeners,
    setNodeRef,
...
function SortableProjectCard({ project, categoryName, onDelete, onEdit }: { project: Project, categoryName: string, onDelete: (id: string) => void, onEdit: (id: string) => void }) {
     const {
        attributes,
        listeners,
        setNodeRef,
    ...
    return (
        <div ref={setNodeRef} style={style} className="bg-card rounded-lg border shadow-sm">
                    ...
                    {items.length > 0 ? (
                        items.map((project) => (
                            <SortableProjectCard
                                key={project.id}
                                project={project}
                                categoryName={categoryMap[project.projectCategoryId] || 'N/A'}
